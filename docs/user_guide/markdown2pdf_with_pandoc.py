...
md_files_for_word = ['user_guide_title.md','user_guide_TOC.md','user_guide_introduction.md',
                     'user_guide_getting_started.md','user_guide_understanding_config.md',
...
output_word_filename = 'TDcoSim_user_guide_version_1_1.docx'
output_pdf_filename = 'TDcoSim_user_guide_version_1_1.pdf'
...
md2word_commandstring = 'pandoc '+ md_files_for_word_string +  ' -o ' + output_word_filename
md2pdf_commandstring = 'pandoc '+ md_files_for_pdf_string +  ' -o ' + output_pdf_filename
